      ...
      <div className="flex flex-col xl:flex-row items-center gap-4 bg-white dark:bg-[#1a1714] rounded-2xl border border-gray-100 dark:border-white/5 shadow-[0_4px_20px_-10px_rgba(4,98,65,0.1)] p-2 w-full">
        ...
        <div className="flex flex-wrap items-center justify-end gap-2 xl:pl-4 xl:border-l border-gray-100 dark:border-white/10 pb-1 xl:pb-0">
          ...
          <SelectDropdown
            ...
            className="flex items-center justify-between gap-1.5 px-3 py-2.5 border border-gray-200 dark:border-white/10 hover:bg-gray-100 dark:hover:bg-white/5 focus:ring-2 focus:ring-[#046241] dark:focus:ring-[#ffb347] focus:outline-none rounded-xl transition-all text-xs font-semibold text-gray-700 dark:text-gray-200 w-[190px]"
            ...
            optionClassName="w-full text-left px-3 py-2 text-xs font-medium text-[#133020] dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-white/10 transition-colors"
          ...
          <SelectDropdown
            ...
            className="flex items-center justify-between gap-1.5 px-3 py-2.5 hover:bg-gray-100 dark:hover:bg-white/5 border border-transparent hover:border-gray-200 dark:hover:border-white/10 focus:ring-2 focus:ring-[#046241] dark:focus:ring-[#ffb347] focus:outline-none rounded-xl transition-all text-xs font-semibold text-gray-700 dark:text-gray-200"
            dropdownClassName="absolute top-full mt-2 left-0 w-full min-w-[180px] bg-white dark:bg-[#1a1714] border border-gray-100 dark:border-white/10 rounded-xl shadow-xl overflow-hidden z-50 animate-in fade-in slide-in-from-top-2 duration-200"
            optionClassName="w-full text-left px-3 py-2 text-xs font-medium text-[#133020] dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-white/10 transition-colors"
            activeOptionClassName="w-full text-left px-3 py-2 text-xs font-bold bg-[#046241]/10 dark:bg-[#046241]/30 text-[#046241] dark:text-[#ffb347] transition-colors"
          />
            ...
            <div className="flex items-center justify-between px-2 py-2 mt-6 mb-4">
              ...
              <div className="flex items-center gap-2">
                <button
                  ...
                  className="px-4 py-2 rounded-xl border border-gray-200 dark:border-white/10 text-xs font-bold text-[#133020] dark:text-white hover:bg-gray-100 dark:hover:bg-white/5 disabled:opacity-40 disabled:cursor-not-allowed transition-all"
                >
                  Previous
                </button>
          ...
          >
            ...
            <div className="flex items-center justify-between p-4 border-b border-gray-100 dark:border-white/5">
              ...
              <div className="flex items-center gap-2">
                ...
                <button 
                  onClick={() => setSelectedCompany(null)} 
                  className="p-2 text-gray-500 hover:bg-gray-200 dark:hover:bg-white/5 rounded-full transition-colors"
                >
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
